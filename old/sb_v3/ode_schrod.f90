MODULE ode_schrod
  ...
  real(kind=dp), save            :: a,b,c,d,height,E, E_temp
...
contains
  ...
  subroutine read_pot
    ...
    !---------------------------------------------------------------------------!
    ! Output:                                                                   !
    ! pot_form, height, a, b, c, d, para_cons, e_temp                           !
    !===========================================================================!
    ...
    !Read in value of energy given as E_temp
    read(10,*) E_temp
  ...
  subroutine find_coeff
    ...
    real(kind=dp)    :: x,Re,Im,k,refl, Tr, E_00
    integer          :: ierr
    
    !Set the value of the scaling parameter E_00
    E_00 = 1.0_dp
    ...
    Tr = exp((-(2.0_dp/3.0_dp)*(height - E)**(3.0_dp/2.0_dp))/(E_00*(2.0_dp*E)**0.25_dp))
        
    !Open a file and write the E vs T data to it
