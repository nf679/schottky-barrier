...
bias on the shape of the potential barrier. It loops over a bias range given in the input file.  (It was made using 
the code in the screenshot in the appendix)
