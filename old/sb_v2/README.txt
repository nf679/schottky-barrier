...
The program has a number of output options. For every option the program creates a file with x, psi data in and 
can optionally calculate a value of the transmission coefficient (asked in the terminal).
...
-output3.dat appended so delete if rerunning program and it already exists 
-output4.dat appended so delete if rerunning program and it already exists
