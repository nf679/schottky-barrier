...
contains
  ...
  subroutine find_coeff
    ...
    !Set the value of the scaling parameter for the padovanni and stratton model
    ...
    !Calculate transmission coefficient using Padovanni and Stratton Model
    delta_E = height - E
    ...
    !The 0.35 is there to scale the data
    write(25,*) E,(1.0_dp-refl)/0.35_dp
