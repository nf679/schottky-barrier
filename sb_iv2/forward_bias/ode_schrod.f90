MODULE ode_schrod
  ...
  INTEGER, SAVE                  :: j_n
  REAL(kind=dp), SAVE            :: para_cons, refl, j_t, j_i
  INTEGER, SAVE                  :: bias_n
  !Variables
  INTEGER                        :: ierr
...
CONTAINS
  ...
  SUBROUTINE read_pot
    ...
    !---------------------------------------------------------------------------!
    ! Output:                                                                   !
    ! pot_form, height, a, b, c, d, para_cons                                   !
    ! E, bias_i, bias_f, bias_n, j_n,                                           !
    !===========================================================================!
    ...
    !Read the parameter for the number of charge carriers
    READ(20,*) j_n
